...
import TikTakToe.exceptions.InvalidGameArgumentsException;
import TikTakToe.strategies.GameWinningStrategy.GameWinningStrategy;
import TikTakToe.strategies.GameWinningStrategy.OrderNGameWinningStrategy;
...
public class Game {
    ...
    public void makeNextMove(){
        ...
        Cell cell = board.getCells()[move.getRow()][move.getCol()];
    ...
    public static class GameBuilder {
        ...
        private void validate() throws InvalidGameArgumentsException {
            // dimensions >= 3
            if(dimensions < 3){
                throw new InvalidGameArgumentsException("Dimensions should be >= 3");
            }
